// RESPOSTA 3
export {} // Para não reclamar de variáveis duplicadas -> IMPORTANTE <-
/** 
...
let botaoLimpar = document.getElementById('limpar-saldo')!; // Exemplo com exclamação no final
...
/** COPIAR e COLAR dentro da tag <head> no HTML
